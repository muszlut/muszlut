...
snakemake \
-s /app/Snakefile \
--directory /scratch/ma95362/257_assembled_files/MTB_ggcaller/257-ggcallaroo_results \
--cores 32 \
--use-conda \
--config \
refs=/scratch/ma95362/257_assembled_files/MTB_ggcaller/257-ggcallaroo_results/input.txt \
bakta_db=/scratch/ma95362/full_bakta_db/db \
output_dir=/scratch/ma95362/257_assembled_files/MTB_ggcaller/257-ggcallaroo_results \
