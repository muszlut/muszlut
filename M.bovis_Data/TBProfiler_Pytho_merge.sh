...
# Define directories
RESULTS_DIR="/scratch/ma95362/ETH_M.bovis/m.bovis_Bactopia_Analysis/with_fixed_reads/M.bovis_paired_end_samples/all_fastqs/TBprofiler_results_conda"
OUTPUT_CSV="/scratch/ma95362/ETH_M.bovis/m.bovis_Bactopia_Analysis/with_fixed_reads/M.bovis_paired_end_samples/all_fastqs/TBprofiler_merge.csv"

# Run the Python merge script
python /home/ma95362/muszlut/M.bovis_Data/merge_tbprofiler.py \
    --dir "$RESULTS_DIR" \
    --out "$OUTPUT_CSV"
