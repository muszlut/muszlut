...
mkdir -p "$CRISPR_DIR/results/P01"

# ===============================
# Prepare input data
# ===============================
# Copy SPAdes contigs to CRISPRbuilder data folder
cp /home/ma95362/crisprbuilder_test/P01/P01_spades/contigs.fasta "$CRISPR_DIR/data/P01/contigs.fasta"
