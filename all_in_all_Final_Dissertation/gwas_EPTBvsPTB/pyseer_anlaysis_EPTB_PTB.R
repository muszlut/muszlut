...
gwas_file <- file.path(gwas_dir, "STR_EPTBvsPTB_gwas.txt")
counts_file <- file.path(gwas_dir, "gene_patterns_STR_EPTBvsPTB_counts.txt")
...
# ---------------------------
write.csv(gwas_data,
          file = file.path(gwas_dir, "STR_EPTBvsPTB_results.csv"),
          quote = FALSE, row.names = FALSE)

write.csv(sig_hits,
          file = file.path(gwas_dir, "STR_EPTBvsPTB_significant_hits.csv"),
          quote = FALSE, row.names = FALSE)
