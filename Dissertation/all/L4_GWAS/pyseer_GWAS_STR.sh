...
PRES="/scratch/ma95362/eth_national_analysis/all_fastq_reads/pangenome_tools_results/bactopia/bactopia-runs/pangenome-20251117-164856/panaroo/struct_presence_absence.Rtab"
...
pyseer \
    ...
    --cpu 16 \
    --output-patterns "${PYSEER_OUT}/gene_patterns_STR_New_L4_T3_ETHfamily.txt" \
    > "${PYSEER_OUT}/STR_New_L4_T3_ETHfamily_gwas.txt"

echo "✅ Pyseer GWAS completed for STR_New_L4_T3_ETHfamily."
