...
genome_list="/scratch/ma95362/eth_national_analysis/all_fastq_reads/pangenome_tools_results/bactopia/genomes_list.txt"

# Create output directory
mkdir -p $PYSEER_OUT
cd $PANAROO_DIR || exit 1
fsm-lite.py  genomes_list.txt kmers.out
# ------------------------------
