...
# Define file paths
# ---------------------------
gwas_dir <- "/scratch/ma95362/eth_national_analysis/all_fastq_reads/ETH_paired_end_samples/bactopia-runs/pangenome_of_1368/panaroo/pyseer_DR_output"
gwas_file <- file.path(gwas_dir, "STR_Combined_VS_L4.2.2.2_gwas.txt")
counts_file <- file.path(gwas_dir, "STR_Combined_VS_L4.2.2.2_pattern_counts.txt")
...
# ---------------------------
write.csv(gwas_data,
          file = file.path(gwas_dir, "STR_combined_VS_L4.2.2.2_results.csv"),
          quote = FALSE, row.names = FALSE)

write.csv(sig_hits,
          file = file.path(gwas_dir, "STR_combined_VS_L4.2.2.2_significant_hits.csv"),
          quote = FALSE, row.names = FALSE)
