...
gwas_file <- file.path(gwas_dir, "Combined_VS_L4.2.2.2_gwas.txt")
counts_file <- file.path(gwas_dir, "Combined_VS_L4.2.2.2_pattern_counts.txt")
...
# ---------------------------
write.csv(gwas_data,
          file = file.path(gwas_dir, "combined_VS_L4.2.2.2_results.csv"),
          quote = FALSE, row.names = FALSE)

write.csv(sig_hits,
          file = file.path(gwas_dir, "combined_VS_L4.2.2.2_significant_hits.csv"),
          quote = FALSE, row.names = FALSE)
