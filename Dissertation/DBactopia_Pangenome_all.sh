#!/bin/bash
#SBATCH --job-name=Bactopia_Pangenome_all_samples
...
# Set directories
OUTDIR="/scratch/ma95362/eth_national_analysis/all_fastq_reads/ETH_paired_end_samples/DBactopia_Pangenome/All_samples"
