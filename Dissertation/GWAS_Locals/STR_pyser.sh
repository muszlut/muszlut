...
PRES="/scratch/ma95362/eth_national_analysis/all_fastq_reads/ETH_paired_end_samples/bactopia-runs/pangenome_local_all/panaroo/struct_presence_absence.Rtab"
...
pyseer \
    ...
    --cpu 16 \
    --output-patterns "${PYSEER_OUT}/STR_patterns_EPTB_PTb.txt" \
    > "${PYSEER_OUT}/STR_EPTB_vs_PTb_gwas.txt"
