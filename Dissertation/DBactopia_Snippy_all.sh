#!/bin/bash
#SBATCH --job-name=Bactopia_Snippy_all_samples
...
OUTDIR="/scratch/ma95362/eth_national_analysis/all_fastq_reads/ETH_paired_end_samples/DBactopia_Snippy/All_samples"
